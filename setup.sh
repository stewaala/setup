...
##################################################
# AS 9Nov13 - insert node installation
sudo apt-get update
...
git config --global user.name 'Alan Stewart'
git config --global user.email 'stewaala@gmail.com'
...
git clone https://github.com/stewaala/dotfiles.git
